...
server.tool(
  'resupply_get_markets',
  'List all available Resupply lending markets (Curve Lend + Fraxlend pools)',
  {}, // No arguments
  async () => {
    try {
...
server.tool(
  'resupply_get_position',
  'Get user position on Resupply (collateral, debt, health factor)',
  {
    address: z.string()
...
server.tool(
  'resupply_simulate_strategy',
  'Simulate a yield farming strategy (project returns)',
  {
    collateralAmount: z.number()
